...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Вы действительно хотите безвозвратно удалить всё из корзины?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Вы действительно хотите восстановить всё из корзины?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Вы действительно хотите восстановить данную запись?");
    setOpenDialog(true);
  };
